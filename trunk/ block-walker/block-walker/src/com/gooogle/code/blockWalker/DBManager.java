...
//    }
    ...
    public boolean saveAll(int option, final String pMap, final int pLife, final int pEnergy) {
            this.mDB = mcontext.getSharedPreferences("DB"+option, Context.MODE_PRIVATE);
